...
export default function CustomerTransaction() {
  ...
  return (
    <CustomerLayout>
      <main className="min-h-screen bg-[#FEF6F0] pt-6 pb-12">
        <div className="max-w-[1280px] mx-auto px-6">
          {/* Outer rounded card */}
          <div className="bg-white rounded-2xl border border-[#F3E6E1] shadow-sm p-6">
            {/* Top padding to account for header in screenshot */}
            <div className="flex gap-8">
              ...
              <section className="flex-1">
                <div className="p-6 bg-transparent rounded-lg">
                  ...
                  {/* Cart list + bottom action bar */}
                  <div className="mt-6">
                    <div className="flex gap-6">
                      {/* list container */}
                      <div className="flex-1">
                        {/* make scroll area with a fixed max height like in screenshot */}
                            ...
                            <div key={item.id} className="flex items-center gap-4 p-4 rounded-lg border border-[#F2E6E2] bg-[#FFFDFC]">
                              ...
                              <div className="flex items-center gap-2 bg-white rounded-full shadow-sm px-3 py-1">
                                <button
                                  ...
                                  className="w-8 h-8 rounded-full hover:bg-[#faf5f4] flex items-center justify-center"
                                >
                        ...
                        {/* bottom action row inside the left column */}
                      ...
                      {/* RIGHT: Order summary column (inside left area row because outer aside exists) */}
                      {/* We'll leave an empty spacer here because the final sidebar is an aside to the right */}
                    </div>
                  </div>
                </div>
              </section>

              {/* RIGHT: ORDER SUMMARY (sticky right column) */}
              <aside className="w-96 flex-shrink-0 ml-6">
                <div className="sticky top-28 p-4 rounded-lg border border-[#F2E6E2] bg-[#FFFDFC]">
                  ...
                  <div className="border-t border-[#F1E4E0] mt-4 pt-4 text-sm">
                    ...
                    <textarea
                      placeholder="Reserve products for visit"
                      className="w-full text-sm p-2 border border-[#F1E4E0] rounded-md mb-3 bg-[#FCF6F4]"
                    />
