// src/pages/AdminProductsDamage.jsx
import { Search, Printer } from 'lucide-react';
import AdminLayout from '../layout/adminLayout';

export default function AdminProductsDamage() {
  const damageRecords = [
    {
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-400 text-sm"
            />
          </div>
          <button
            onClick={() => window.print()}
            className="px-6 py-3 bg-pink-400 text-white font-medium rounded-xl hover:bg-pink-500 transition flex items-center gap-2"
          >
