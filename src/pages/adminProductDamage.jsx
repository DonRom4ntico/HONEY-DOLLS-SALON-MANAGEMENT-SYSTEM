    ...
    <AdminLayout title="Product Damage Records">
        ...
        <div className="flex items-center gap-4 flex-wrap md:flex-nowrap">
          ...
          <div className="relative w-[250px]">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-full text-gray-600 focus:outline-none focus:ring-2 focus:ring-pink-400"
            />
          </div>
          ...
          <button
            ...
            className="bg-gradient-to-r from-pink-500 to-red-500 text-white font-medium px-4 py-2 rounded-full flex items-center gap-2 shadow hover:shadow-lg transition h-[40px] hover:scale-103"
          style={{
      ...
      boxShadow: '0 4px 15px rgba(236, 72, 153, 0.4)',
          ...
          <button
            ...
            className="bg-pink-200 hover:bg-pink-300 text-pink-800 font-medium px-6 py-2 rounded-full flex items-center gap-2 shadow transition h-[40px]"
          >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-8">
            ...
            <div className="flex justify-end gap-4 mt-8">
              ...
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-pink-500 to-red-500 text-white font-medium rounded-lg shadow hover:shadow-lg transition hover:scale-103"
              style={{
      background: 'linear-gradient(to right, #ec4899, #f97316)',
      padding: '10px 24px',
      borderRadius: '9999px',
