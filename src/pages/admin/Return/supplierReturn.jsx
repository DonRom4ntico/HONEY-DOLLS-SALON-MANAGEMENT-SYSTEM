      ...
      <AdminLayout title="">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="py-4">
                  ...
                  <p className="text-gray-700">Manage products returned to suppliers</p>
                </div>
              </div>
            </div>
          </div>
...
<div className="mb-8"></div>
                ...
                <tbody className="divide-y divide-gray-100">
                  {filteredReturns.map((ret) => (
                    <tr key={ret.id} className="hover:bg-orange-50 transition">
                      ...
                      <td className="px-6 py-5 font-medium text-gray-900">{ret.supplier}</td>
            ...
            <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
              <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl p-8">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">New Supplier Return</h2>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <select className="w-full px-5 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-400">
                        ...
                        <option>Keratin Smooth Oil 500ml</option>
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Attach Evidence (Photos)</label>
 ...
 background: 'linear-gradient(to right,  #ec4899, #f97316)', 
  ...
  borderRadius: '9999px',
  boxShadow: '0 4px 15px rgba(34, 211, 238, 0.3)',}}  
                  className="hover:scale-103 px-10 py-3 bg-gradient-to-r from-orange-500 to-pink-500 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition">
                    Submit Return
                  </button>
                </div>
              </div>
