      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="ml-[16px]">
            {" "}
            {/* Adjust this margin to match search bar's left edge */}
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredReturns.map((ret) => (
                  <tr key={ret.id} className="hover:bg-orange-50 transition">
                    ...
                    <td className="px-6 py-5 text-center">
                      <span
                        className={`inline-block px-5 py-2 rounded-full text-white font-bold text-sm ${getStatusColor(ret.status)}`}
                      >
                        {ret.status}
                      </span>
                    </td>
                        ...
                        {ret.status === "Pending" ? (
                          <>
                            <button
                              style={{
                                background:
                                  "linear-gradient(to right, #86efac, #22d3ee)",
                                padding: "10px 24px",
                                borderRadius: "9999px",
                                boxShadow: "0 4px 15px rgba(34, 211, 238, 0.3)",
                              }}
                              className="px-5 py-2 rounded-full text-sm font-bold shadow hover:shadow-lg transition hover:scale-103"
                            >
                              Return
                            </button>
                            <button
                              ...
                              className="px-5 py-2 rounded-full text-sm font-bold shadow hover:shadow-lg transition hover:scale-103 text-white"
                            >
                              Replace
                            </button>
                          </>
