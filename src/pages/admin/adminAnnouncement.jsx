  ...
  const announcements = [
    {
      ...
      audience: "All Users",
      content:
        "We will be performing scheduled maintenance on our servers from 2:00 AM to 4:00 AM EST...",
    },
    {
      id: 2,
    ...
    <AdminLayout title="Announcements">
      <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              />
              <Calendar className="absolute left-3 top-12 sm:top-3 w-5 h-5 text-gray-400" />
            </div>
            <div className="relative flex-1">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Start Time
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-400"
              />
              <Clock className="absolute left-3 top-12 sm:top-3 w-5 h-5 text-gray-400" />
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-4 mb-10">
          ...
          <button
            className="px-10 py-3 rounded-xl font-extrabold text-sm text-white 
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 sm:gap-0">
          ...
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-400 w-full"
            />
          </div>
        </div>
