            ...
            <tbody>
              {paginated.map((item) => (
                <tr key={item.id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="text-center py-4 px-6 text-orange-700 font-bold">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md max-h-screen overflow-y-auto">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewService({ ...newService, amount: e.target.value })
                    }
                    placeholder="2500"
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-400"
                  />
              ...
              <div className="flex gap-4 mt-8">
                ...
                <button
                  ...
                  disabled={
                    !newService.name || !newService.type || !newService.amount
                  }
                  style={{
                    background:
                      newService.name && newService.type && newService.amount
