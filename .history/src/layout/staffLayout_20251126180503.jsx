...
export default function StaffLayout({ children }) {
  ...
  const staffName = "Anna"; // Dynamic name here if needed
        ...
        <div className="px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className=" hidden text-orange-900"
            >
              {mobileMenuOpen ? (
                <X className="w-7 h-7" />
              ) : (
          ...
          {/* DESKTOP NAV */}
          <nav className=" lg:flex items-center gap-10 text-base font-semibold text-orange-900">
            {navLinks.map((link) => (
              <button
                key={link.name}
