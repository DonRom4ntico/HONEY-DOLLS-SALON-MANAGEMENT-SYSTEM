      ...
      <main className="flex-1 px-6 py-8 max-w-7xl mx-auto w-full">
        <div className="grid lg:grid-cols-[2fr_1fr] gap-8 h-[calc(100vh-100px)]">
          ...
          <div className="bg-gray-50 rounded-2xl p-5 flex flex-col h-full overflow-y-auto">
            <div ref={receiptRef} className="hidden print:block p-4">
              {/* RECEIPT HEADER */}
              ...
              {/* RECEIPT TABLE */}
              <table className="w-full text-sm border-t border-b border-gray-300 py-2">
                <thead>
              ...
              <p className="mt-6 text-center text-gray-700 text-sm">
                Thank you for choosing Honey Dolls Salon!
              </p>
            </div>
