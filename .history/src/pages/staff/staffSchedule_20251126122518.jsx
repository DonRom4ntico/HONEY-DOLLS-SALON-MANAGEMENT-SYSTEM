  ...
  const appointments = [
    {
      ...
      customer: 'Alita Angel Pangaliban',
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-orange-900 font-medium text-sm hidden sm:inline">
              Welcome, Alita Smith <span className="text-yellow-600">Philippines</span>
            </span>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 px-6 py-8 max-w-7xl mx-auto w-full">
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-lg p-6">
              {/* Table Header */}
              <div className="grid grid-cols-4 text-sm font-semibold text-gray-700 border-b pb-3">
                <div>Time</div>
              ...
              <div className="mt-4 space-y-3">
                {filteredAppointments.map((apt) => {
                  ...
                  return (
                    <div
                      key={apt.id}
                      className={`grid grid-cols-4 items-center p-3 rounded-xl ${statusColor} transition`}
                    >
      ...
      <footer className="bg-white/80 py-3 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-xs text-gray-600 text-center">
            Staff view • Visible only to logged-in staff • Honey Dolls — Brilliant Beauty Hub
          </p>
        </div>
      </footer>
    </div>
