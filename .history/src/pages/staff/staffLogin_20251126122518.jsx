...
const StaffLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      navigate("/staff/dashboard"); // or wherever your staff dashboard is
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-teal-50 flex flex-col">
      {/* ====================== HEADER ====================== */}
        ...
        <div className="w-full max-w-md">
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-10">
            ...
            <div className="text-center mb-10">
              <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-full shadow-xl mb-5">
                <Users className="w-14 h-14 text-white" />
              </div>
              <h1 className="text-4xl font-bold text-gray-800">Staff Login</h1>
              <p className="text-gray-600 mt-2 text-lg">Welcome back, team member!</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-7">
              <div>
                ...
                <input
                  ...
                  placeholder="staff@honeybrilliant.com"
                  className="w-full px-5 py-4 bg-white/70 border border-gray-300 rounded-xl focus:outline-none focus:ring-4 focus:ring-teal-300 focus:border-teal-500 transition-all placeholder-gray-400 font-medium"
                  required
                  disabled={loading}
                />
              </div>
              ...
              {/* SAME ORANGE-PINK BUTTON AS CUSTOMER & ADMIN */}
              <button
                type="submit"
                disabled={loading}
            ...
            <div className="mt-8 text-center text-xs text-gray-500">
              <p>This portal is for salon staff members only.</p>
              <p>Admin access requires separate credentials.</p>
            </div>
          </div>
        </div>
      </main>
