...
export default function StaffPOS() {
  ...
  const [items, setItems] = useState([]); // combined products & services
  ...
  const subtotal = cart.reduce(
    (sum, item) => sum + item.quantity * (item.price || item.unit_price),
    0
  );
          ...
          <div className="grid lg:grid-cols-3 gap-8">
                      ...
                      >
                        ...
                        <div className="p-3">
                          ...
                          <p className="text-sm text-gray-600">
                            ₱{item.price} • {item.duration || "Service"}
                          </p>
                          <button
            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-50 rounded-2xl p-5 h-full flex flex-col">
                ...
                <div className="border-t pt-3 mb-4 flex justify-between text-lg font-bold">
                  <span>Subtotal</span>
