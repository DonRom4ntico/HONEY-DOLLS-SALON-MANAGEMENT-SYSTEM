...
export default function StaffPOS() {
  ...
  const handlePrint = useReactToPrint({
    ...
    removeAfterPrint: true, // optional: close print dialog automatically
  });
  ...
  const handleConfirmPay = async () => {
    ...
    try {
      ...
      // Trigger print immediately after payment
        ...
        <div className="grid lg:grid-cols-[2fr_1fr] gap-8 h-[calc(100vh-100px)]">
          ...
          <div className="bg-gray-50 rounded-2xl p-5 flex flex-col h-full overflow-y-auto">
            ...
            <div className="space-y-3 mt-4">
              ...
              <button
                onClick={() => {
                  if (receiptRef.current && cart.length > 0) {
                    handlePrint();
                  } else {
                    alert("Nothing to print. Add items to the cart first.");
                  }
                }}
