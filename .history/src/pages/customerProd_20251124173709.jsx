...
const CustomerProd = () => {
  ...
  const FilterSidebar = () => (
    <aside className="w-56 bg-white rounded-xl p-6 shadow-sm h-fit">
      ...
      <p className="text-sm font-semibold text-gray-800 mb-3">Filter by Category</p>
      ...
      <div className="min-h-screen bg-gradient-to-b from-orange-50 to-pink-50 pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className={`${isFilterOpen ? "fixed inset-0 z-40 bg-black/50" : "hidden"} lg:block lg:static lg:z-auto`}
              onClick={() => setIsFilterOpen(false)}>
              <div
                className={`${isFilterOpen ? "fixed left-0 top-0 h-full w-80 bg-white shadow-2xl p-6 overflow-y-auto" : ""} lg:w-64 lg:block`}
                ...
                {filteredProducts.map((product) => (
                  <div
                    ...
                    onClick={() => {
                      ...
                      setQuantity(1);
                      setIsFilterOpen(false); // Close mobile filter when viewing product
                    }}
                  >
                    ...
                    <button className="mt-4 w-full bg-[#fca9a9] hover:bg-[#fb8d8d] text-white text-sm py-2 rounded-lg font-medium transition opacity-0 group-hover:opacity-100 lg:opacity-100">
                      View Product
                    </button>
                  </div>
                ))}
