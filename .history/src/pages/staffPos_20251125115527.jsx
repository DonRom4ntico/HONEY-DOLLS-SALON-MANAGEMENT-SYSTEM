...
export default function StaffPOS() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Map IDs consistently for easier cart handling
        const mappedProducts = prodRes.data.products.map((p) => ({
          ...p,
          id: p.productid,
          type: "product",
          price: parseFloat(p.price),
        }));
        const mappedServices = servRes.data.services.map((s) => ({
          ...s,
          id: s.serviceid,
          type: "service",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-pink-50 flex flex-col">
      ...
      {/* ================= MAIN ================= */}
      <main className="flex-1 px-6 py-8 max-w-7xl mx-auto w-full flex gap-6">
        {/* LEFT / CENTER: Products & Services */}
            ...
            {allItems
              ...
              .map((item) => {
                ...
                return (
                  ...
                  >
                    <div className="relative h-20 bg-gray-200 border-2 border-dashed rounded-t-2xl" />
                    {added > 0 && (
                    ...
                    <div className="p-3">
                      ...
                      <button
                        ...
                        className="mt-2 w-full bg-yellow-400 text-gray-900 font-medium py-2 rounded-full hover:bg-yellow-500 transition text-sm flex items-center justify-center"
                      >
        ...
        {/* RIGHT: Cart / Receipt */}
        <div className="w-80 bg-gray-50 rounded-2xl p-5 flex flex-col">
          <h3 className="font-bold text-gray-900 mb-4">Cart / Receipt</h3>
          <div className="flex-1 space-y-2 mb-4 overflow-y-auto max-h-[60vh]">
            {cart.length === 0 ? (
