        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Where self-care is not a luxury, but a necessity. Discover your
              inner beauty with our all-in-one beauty services in the heart of
              Davao.
            </p>
          </section>
          ...
          <section className="grid md:grid-cols-2 gap-12 mb-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                At Honey Dolls & Brilliant Beauty Hub, we empower every
                individual to embrace their unique beauty through personalized,
                high-quality services. We believe in creating a welcoming space
                where you can relax, rejuvenate, and rediscover your confidence.
                Our commitment is to deliver exceptional beauty experiences that
                leave you feeling radiant inside and out.
              </p>
            </div>
          ...
          <section className="bg-white rounded-3xl shadow-xl p-12 mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Founded in the vibrant city of Davao, Honey Dolls & Brilliant
                  Beauty Hub started as a small dream to bring world-class
                  beauty services to our local community. What began as a
                  passion for making women feel beautiful and empowered has
                  grown into a beloved hub where thousands come to unwind and
                  transform.
                </p>
                <p>
                  Located at{" "}
                  <strong>DGGG Y10, CM Recto Corner Emilio Jacinto</strong> (in
                  front of Vivaldi Residences Davao), we’re open daily from
                  <strong> 9:00 AM – 9:00 PM</strong>.
                </p>
                <p>
                  We only use premium, safe products and our skilled stylists
                  are always updated with the latest trends — ensuring every
                  visit leaves you glowing.
                </p>
              </div>
              <div>
                <img
                  src="/react-sidebar/src/logoe.png" // ← Change this to your actual salon photo
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-pink-50 p-8 rounded-2xl text-center hover:shadow-xl transition">
                ...
                <p className="text-gray-700">
                  Cuts, colors, keratin, rebonding & more
                </p>
              </div>
              ...
              <div className="bg-yellow-50 p-8 rounded-2xl text-center hover:shadow-xl transition">
                ...
                <p className="text-gray-700">
                  Manicure, pedicure, gel polish, extensions
                </p>
              </div>
              ...
              <div className="bg-orange-50 p-8 rounded-2xl text-center hover:shadow-xl transition">
                ...
                <p className="text-gray-700">
                  Diamond peel, hydrofacial, anti-acne treatments
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-r from-pink-100 to-orange-100 rounded-3xl p-12 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-10 text-lg">
              <div>
                ...
                <p className="text-gray-700">
                  DGGG Y10, CM Recto Corner Emilio Jacinto
                  <br />
                  (In front of Vivaldi Residences)
                  <br />
              ...
              <div>
                ...
                <p className="text-gray-700">
                  FB: Honey Dolls & Brilliant Beauty Hub
                  <br />
