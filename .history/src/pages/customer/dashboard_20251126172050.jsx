    ...
    <CustomerLayout>
      ...
      <section className="relative min-h-screen text-white overflow-hidden">
        ...
        <div
          ...
          style={{ backgroundImage: "url('/react-sidebar/src/logoe.png')" }}
        />
      ...
      >
        ...
        <div className="max-w-7xl mx-auto space-y-32">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <img
              src="/react-sidebar/src/Img2.png"
              alt="Hair"
              className="w-full h-80 md:h-96 object-cover rounded-2xl shadow-xl"
            />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <img
              src="/react-sidebar/src/Img3.png"
              alt="Nail Care"
              className="w-full h-80 md:h-96 object-cover rounded-2xl shadow-xl"
            />
            <div className="text-left">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <img
              src="/react-sidebar/src/Img4.png"
              alt="Nail Extension"
              className="w-full h-80 md:h-96 object-cover rounded-2xl shadow-xl"
            />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <img
              src="/react-sidebar/src/Img5.png"
              alt="Facial Services"
              className="w-full h-80 md:h-96 object-cover rounded-2xl shadow-xl"
            />
            <div className="text-left">
