            ...
            <div className="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 border-t border-gray-200">
                <button
                  ...
                  className={`${gradientBtn} hover:scale-101 bg-gradient-to-r from-orange-500 to-pink-500 px-8 py-4 inline-flex items-center gap-3`}
                >
              ...
              <div className="p-6 text-center">
                <button
                  ...
                  className={`${gradientBtn} hover:scale-101 bg-gradient-to-r from-pink-500 to-orange-500 text-xl px-16 py-5`}
                >
            ...
            <div className="bg-white rounded-2xl shadow-lg border p-6 sticky top-6">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className={`${gradientBtn} hover:scale-101 w-full bg-gradient-to-r from-pink-500 to-orange-500 text-lg py-5 mt-6`}
                >
                  Finalize Order
                </button>
              </div>
