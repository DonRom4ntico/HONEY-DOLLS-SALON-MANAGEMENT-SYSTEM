...
export default function StaffPOS() {
  ...
  // THIS STATE WILL TRIGGER PRINT AFTER PAYMENT CONFIRMED
  ...
  const handleConfirmPay = async () => {
    ...
    try {
      ...
      // trigger print AFTER React updates receipt
  ...
  // Trigger printing after amountPaid updates
  useEffect(() => {
    if (printTrigger && receiptRef.current) {
      handlePrint();
      setPrintTrigger(false); // reset
    }
  }, [printTrigger]);
